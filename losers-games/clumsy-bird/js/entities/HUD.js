    ...
    draw: function (renderer) {
        if (game.data.start && me.state.isCurrent(me.state.PLAY)) {
            ...
            if (game.data.steps >= 10) {
                document.body.innerText = 'не ну ты харош, пиши о победе боту пароль-код из 4 цифр. подумай каких :thinking-face: (ну и если что проси подсказку, если совсем тяжко, но в целом должно быть понятно, цифра 4...... 4 чего-то....'
            }
        }
    }
